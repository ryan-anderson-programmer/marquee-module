...
$parameters = @{
    ...
    Description       = 'This module contains a function that can be used to display information about a module or script.'
    Author            = 'Ryan E. Anderson'
    Copyright         = 'Copyright (C) 2023 Ryan E. Anderson'
    Tags              = @('marquee', 'information', 'comments', 'box', 'command-line-interface', 'CLI', 'author', 'copyright', 'fine-print', 'title', 'description', 'shell', 'terminal', 'text')
